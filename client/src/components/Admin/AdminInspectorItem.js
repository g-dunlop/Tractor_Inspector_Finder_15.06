    ...
    return (
        <>
            <tr>
                ...
                <td>
                    <button className="notes" onClick={handleNotesClick}><img src={Notes} height="33px" width="40px" alt="a notebook" /></button>
                   ...
                   <td><div className="table-buttons"><Nav.Link href={`admin/${inspector.id}`}><Button className="table-button" size="sm" onClick={handleUpdate} value={inspector.id}>Update</Button></Nav.Link><Button className="table-button" variant="danger" size="sm"  onClick={handleDelete} value={inspector.id}>Delete</Button></div></td> 
            </tr>
        </>
    )
}
